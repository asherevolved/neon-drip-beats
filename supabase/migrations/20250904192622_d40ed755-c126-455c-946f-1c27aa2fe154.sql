-- Add authorized admin user profile
-- This will ensure asherthemaverick@gmail.com has admin access
INSERT INTO public.profiles (id, email, role, created_at)
VALUES (
  gen_random_uuid(),
  'asherthemaverick@gmail.com',
  'admin',
  now()
)
ON CONFLICT (email) DO UPDATE SET role = 'admin';

-- Also create a function to automatically assign admin role to this specific email
